...
6.  **Arrange your reference layers:**
    ...
    ![Figure 1 - Reference layers: boundaries and aerial photo](georeferencing_and_digitizing/fig%201.png)
...
9.  **Add the raster for interactive georeferencing:**
    ...
    ![Figure 2 - Unreferenced map loaded in the canvas](georeferencing_and_digitizing/fig%202.png)
...
10. **Interactively position and scale the map:**
    ...
    **Tips for initial positioning:**
    ...
    ![Figure 3 - Initial rough positioning of the map](georeferencing_and_digitizing/fig%203.png)
...
::: callout-note How the 2-Point Tool Works
...
![fig 4](georeferencing_and_digitizing/fig%204a.png)
...
14. **Verify the result:**
    ...
    **Quality check questions:**
    ...
    ![Figure 5 - Final georeferenced map overlay](georeferencing_and_digitizing/fig%204b.png)
...
16. **Create a new vector layer for digitizing:**
    ...
    **Add attribute fields:**
    ...
    ![Figure 6 - Creating a new vector layer for digitizing](georeferencing_and_digitizing/fig 5.png)
...
17. **Start digitizing:**
    ...
    **Digitizing tips:**
    ...
    ![Figure 7 - Digitizing building polygons](georeferencing_and_digitizing/fig 6.png)
...
20. **Save your edits:**
    ...
    ![Figure 8 - Completed digitized buildings](georeferencing_and_digitizing/fig 7.png)
