...
**Data files:**
- `buildings.gpkg` - Rotterdam building footprints with function data
- `buurten.gpkg` - Rotterdam neighborhoods (buurten)
------------------------------------------------------------------------
...
![Figure 1 - Loaded building and neighborhood layers](statistics_and_data_visualization/fig%201.png)
...
![Figure 2 - Building attribute table showing function column](statistics_and_data_visualization/fig%202.png)
...
![Figure 3 - Field Calculator creating function_type field](statistics_and_data_visualization/fig%203.png)
...
9.  **Verify your results:**
    ...
    -   Check that single-function buildings show their specific function name
        ...
        ![](statistics_and_data_visualization/fig%20x1.png)
...
![Figure 4 - Select by Location dialog](statistics_and_data_visualization/fig%204.png)
...
![Figure 5 - Join Attributes by Location dialog](statistics_and_data_visualization/fig%205.png)
...
4.  **Verify the join:**
    ...
    -   Verify that buildings have the correct neighborhood assigned
        ...
        ![](statistics_and_data_visualization/fig%20x2.png)
...
![Figure 6 - Calculating building areas](statistics_and_data_visualization/fig%206.png)
...
1.  **Go to:** `Processing Toolbox` → `Vector Analysis` → `Statistics by Categories`
...
![Figure 7 - Statistics by Categories for counts](statistics_and_data_visualization/fig%207.png)
...
![Figure 8 - Statistics by Categories for areas](statistics_and_data_visualization/fig%208.png)
...
1.  **Go to:** `Processing Toolbox` → `Vector Analysis` → `Aggregate`
...
![Figure 9 - Aggregate tool configuration](statistics_and_data_visualization/fig%209.png)
...
7.  **Review the results:**
    ...
    -   Each row = one function type in one neighborhood with count, total area, and size statistics
        ...
        ![](statistics_and_data_visualization/fig%20x3.png)
...
![Figure 10 - Export CSV configuration](statistics_and_data_visualization/fig%2010.png)
...
4.  **Verify your export:**
    ...
    -   Verify data looks correct
        ...
        ![](statistics_and_data_visualization/fig%20x4.png)
...
![Figure 11 - Bar chart of building counts by function](statistics_and_data_visualization/fig%2011.png)
...
![Figure 12 - Treemap showing area distribution](statistics_and_data_visualization/fig%2012.png)
